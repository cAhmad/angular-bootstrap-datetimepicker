        ...
        function DirectiveController ($scope, $element, $attrs) {
            ...
            function setTime (milliseconds) {
                ...
                switch (configuration.modelType) {
                    case 'Date':
                        newDate = configuration.utcOnly ? new Date(milliseconds) : new Date(tempDate.getUTCFullYear(), tempDate.getUTCMonth(), tempDate.getUTCDate(), tempDate.getUTCHours(), tempDate.getUTCMinutes(), tempDate.getUTCSeconds(), tempDate.getUTCMilliseconds())
                        break
                    case 'moment':
                        newDate = configuration.utcOnly ? moment(milliseconds) : moment([tempDate.getUTCFullYear(), tempDate.getUTCMonth(), tempDate.getUTCDate(), tempDate.getUTCHours(), tempDate.getUTCMinutes(), tempDate.getUTCSeconds(), tempDate.getUTCMilliseconds()])
                        break
                    case 'milliseconds':
